...
!!! info "Sayfa Bilgisi"
    ...
    **Anahtar kelimeler:** `CMOS` · `monokrom kamera` · `gain` · `offset` · `read noise` · `full well capacity` · `sampling` · `pixel scale`

**Durum: Taslak**

## Amaç

Bu bölüm, CMOS ve Monokrom Kamera konusunun PixInsight tabanlı monokrom astrofotoğraf işleme akışındaki yerini ve temel karar noktalarını açıklamak için hazırlanmıştır.
...
- [Veri Kalitesi ve Entegrasyon Stratejileri](../15-workflows/data-quality-strategies.md)
