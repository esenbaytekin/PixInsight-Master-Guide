...
!!! info "Sayfa Bilgisi"
    ...
    **Anahtar kelimeler:** `SHO` · `Hubble Palette` · `SII Ha OIII` · `narrowband` · `dar bant` · `Ha OIII SII`
...
Bu bölüm, SHO konusunun PixInsight tabanlı monokrom astrofotoğraf işleme akışındaki yerini ve temel karar noktalarını açıklamak için hazırlanmıştır.
