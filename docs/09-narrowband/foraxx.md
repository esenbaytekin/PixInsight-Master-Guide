...
!!! info "Sayfa Bilgisi"
    ...
    **Anahtar kelimeler:** `Foraxx` · `Foraxx Palette` · `narrowband` · `dar bant` · `Ha OIII SII`
...
Bu bölüm, Foraxx konusunun PixInsight tabanlı monokrom astrofotoğraf işleme akışındaki yerini ve temel karar noktalarını açıklamak için hazırlanmıştır.
