...
!!! info "Sayfa Bilgisi"
    ...
    **Anahtar kelimeler:** `HOO` · `Ha OIII OIII` · `narrowband` · `dar bant` · `Ha OIII SII`
...
Bu bölüm, HOO konusunun PixInsight tabanlı monokrom astrofotoğraf işleme akışındaki yerini ve temel karar noktalarını açıklamak için hazırlanmıştır.
