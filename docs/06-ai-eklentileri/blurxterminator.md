...
!!! note "AI4 ve SPCC sırası"
    Üretici kılavuzu, hassas color calibration öncesinde `Correct Only`, SPCC sonrasında ise istenen sharpening ayarlarıyla ikinci bir geçişi ayrı bir seçenek olarak önerir. Tek post-SPCC geçişi sade bir iş akışı dalıdır; iki aşamalı yaklaşımın yerine evrensel kural olarak sunulmaz.
