...
!!! info "Sayfa Bilgisi"
    ...
    **Anahtar kelimeler:** `LRGB` · `case study` · `uygulama` · `end-to-end workflow`

**Durum: Taslak**

## Amaç

Bu bölüm, LRGB konusunun PixInsight tabanlı monokrom astrofotoğraf işleme akışındaki yerini ve temel karar noktalarını açıklamak için hazırlanmıştır.
