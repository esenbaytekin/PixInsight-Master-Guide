# NoiseXTerminator Validation Checklist

## Preflight

- [x] Registry dosyası mevcut ve YAML yapısı geçerli.
- [x] `noisexterminator` exact ve case-sensitive registry anahtarıyla eşleşti.
...
- [x] Sayılar ve checkbox durumları default olarak sunulmadı.
...
- [x] Doğrulanmış plugin sürümü, menü yolu ve kontroller kanıta bağlandı.
