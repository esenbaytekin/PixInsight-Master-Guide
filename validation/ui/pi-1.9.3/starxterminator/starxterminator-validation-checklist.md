# StarXTerminator Validation Checklist

## Preflight

- [x] Registry dosyası mevcut ve YAML yapısı geçerli.
- [x] `starxterminator` exact ve case-sensitive registry anahtarıyla eşleşti.
...
- [x] Hidden `Select AI` ve Mask seçenekleri çıkarılmadı.
- [x] Checkbox durumları default olarak sunulmadı.
...
- [x] Doğrulanmış plugin sürümü, menü yolu, ana ve batch kontroller kanıta bağlandı.
- [x] Görünen durumlar `UI-OBSERVED` olarak ayrıldı.
